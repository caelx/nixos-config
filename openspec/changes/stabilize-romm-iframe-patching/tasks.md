...
- [x] 3.2 Apply the updated config on `chill-penguin`, then verify `systemctl status podman-romm.service --no-pager -l`, `podman ps`, and the iframe behavior against the live served RomM app.
