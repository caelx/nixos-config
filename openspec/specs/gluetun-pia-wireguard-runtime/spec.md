# gluetun-pia-wireguard-runtime Specification

## Purpose
Define the Ghostship runtime contract for running Gluetun on `chill-penguin`
through PIA WireGuard with dynamic PF-capable server selection, preserved VPN-
side port forwarding, and explicit monitoring of VPN and forwarded-port health.
