...
## Purpose
Define the supported WSL contract for keeping Linux/FHS compatibility through `envfs` while using explicit Windows interop entrypoints instead of imported Windows PATH executables.
