# hermes-shared-skill-seeds Specification

## Purpose
Define repo-managed shared Hermes skill seed content and copy-once runtime
seeding behavior for shared skills under `/home/hermes/seeds/shared/skills/`.
