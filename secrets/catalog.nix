...

{
  units = {
    ...
    hermes-secrets = {
      ...
      mode = "0400";
      format = "env";
      exports = [ "SYNOLOGY_USER" "SYNOLOGY_PASS" "GOOGLE_AI_STUDIO_API_KEY" "OPENCODE_GO_API_KEY" "OPENCODE_ZEN_API_KEY" "ZENMUX_API_KEY" "ELECTRON_HUB_API_KEY" "OPENROUTER_API_KEY" "BWS_ACCESS_TOKEN" "DISCORD_BOT_TOKEN" "WEBHOOK_SECRET" "CHANGEDETECTION_API_KEY" "BW_CLIENTID" "BW_CLIENTSECRET" "BW_PASSWORD" "GITHUB_TOKEN" "NVIDIA_BUILD_API_KEY" "OLLAMA_API_KEY" ];
    };
