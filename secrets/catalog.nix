...

{
  units = {
    ...
    hermes-secrets = {
      ...
      mode = "0400";
      format = "env";
      exports = [ "SYNOLOGY_USER" "SYNOLOGY_PASS" "GOOGLE_AI_STUDIO_API_KEY" "OPENCODE_GO_API_KEY" "OPENROUTER_API_KEY" "BWS_ACCESS_TOKEN" "DISCORD_BOT_TOKEN" "WEBHOOK_SECRET" "CHANGEDETECTION_API_KEY" ];
    };
    ...
    pyload-secrets = {
      ...
      mode = "0400";
      format = "env";
      exports = [ "PYLOAD_USER" "PYLOAD_PASS" ];
    };
  ...
  projections = {
    ...
    hermes = {
      ...
      fields = {
        ...
        BAZARR_API_KEY = { unit = "bazarr-secrets"; key = "BAZARR_API_KEY"; };
        CHAPTARR_API_KEY = { unit = "chaptarr-secrets"; key = "CHAPTARR_API_KEY"; };
        PYLOAD_USER = { unit = "pyload-secrets"; key = "PYLOAD_USER"; };
        PYLOAD_PASS = { unit = "pyload-secrets"; key = "PYLOAD_PASS"; };
