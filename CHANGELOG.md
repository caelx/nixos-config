...
### Added
- **Honcho stack**: Added a local Honcho API/worker/database/Redis stack for Hermes, wired Hermes to generate `~/.honcho/config.json` at startup, and added Homepage and Muximux entries.
