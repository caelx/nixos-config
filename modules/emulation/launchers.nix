...
EOF
    ...
    // Config-only raw GZDoom events. Without the removed input translation
    // patch, SDL joystick buttons arrive as JoyN and the D-pad arrives as POV1.
    bind joy2 +use
    bind joy1 +jump
    bind joy3 crouch
    bind joy4 +reload
...
# later axes stay disabled except trigger-axis button fallbacks.
axis_settings = {
    "Axis0deadzone": "0.20",
    "Axis0map": "3",
    "Axis1deadzone": "0.20",
