...
let
  ...
  openchamberDoctor = pkgs.writeShellScriptBin "openchamber-doctor" ''
    ...
    su-exec openchamber:openchamber ${openchamberToolMaintenance}/bin/openchamber-tool-maintenance
    su-exec openchamber:openchamber ${openchamberRunHooks}/bin/openchamber-run-hooks doctor.d
  '';
  ...
  openchamberImage = pkgs.dockerTools.buildLayeredImageWithNixDb {
    ...
    extraCommands = ''
      ...
      Requires=openchamber-container-setup.service dockerd.service openchamber-user-manager.service
      ...
      DefaultDependencies=no
      Wants=openchamber-container-setup.service dockerd.service openchamber-user-manager.service openchamber-bootstrap.service openchamber-web.service openchamber-tool-auto-update.timer openchamber-web-monitor.timer
      After=openchamber-container-setup.service dockerd.service openchamber-user-manager.service openchamber-bootstrap.service
      AllowIsolate=yes
      EOF
