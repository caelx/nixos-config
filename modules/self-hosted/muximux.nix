    ...
    text = ''
      ...
      if [ -f "$CONFIG_FILE" ]; then
        ...
        ${pkgs.ghostship-config}/bin/ghostship-config set "$CONFIG_FILE" \
          ...
          Arcane.name=literal:"Arcane" \
          Arcane.url=literal:"https://arcane.ghostship.io" \
          Arcane.scale=literal:1 \
          Arcane.icon=literal:"muximux-archlinux" \
          Arcane.color=literal:"#8e51ff" \
          Arcane.enabled=literal:"true" \
          ...
          PriceGhost.name=literal:"PriceGhost" \
          PriceGhost.url=literal:"https://priceghost.ghostship.io" \
          PriceGhost.scale=literal:1 \
          PriceGhost.icon=literal:"muximux-ghost" \
          PriceGhost.color=literal:"#6b7280" \
          PriceGhost.enabled=literal:"true" \
          ...
          HomeAssistant.name=literal:"HomeAssistant" \
          HomeAssistant.url=literal:"https://homeassistant.ghostship.io" \
          HomeAssistant.scale=literal:1 \
          HomeAssistant.icon=literal:"muximux-homeassistant" \
          HomeAssistant.color=literal:"#18bcf2" \
          HomeAssistant.enabled=literal:"true" \
          HomeAssistant.dd=literal:"true" \
          ...
          Booklore.name=literal:"Booklore" \
          Booklore.url=literal:"https://booklore.ghostship.io" \
          Booklore.scale=literal:1 \
          Booklore.icon=literal:"muximux-book2" \
          Booklore.color=literal:"#49da7e" \
          Booklore.enabled=literal:"true" \
          Booklore.dd=literal:"true" \
          Warracker.name=literal:"Warracker" \
          Warracker.url=literal:"https://warracker.ghostship.io" \
          Warracker.scale=literal:1 \
          Warracker.icon=literal:"muximux-receipt" \
          Warracker.color=literal:"#339af0" \
          Warracker.enabled=literal:"true" \
          Warracker.dd=literal:"true" \
          Fileflows.name=literal:"Fileflows" \
          Fileflows.url=literal:"https://fileflows.ghostship.io" \
          Fileflows.scale=literal:1 \
          Fileflows.icon=literal:"muximux-alt_route" \
          Fileflows.color=literal:"#ff0090" \
          Fileflows.enabled=literal:"true" \
          Fileflows.dd=literal:"true" \
          ActivePieces.name=literal:"ActivePieces" \
          ActivePieces.url=literal:"https://activepieces.ghostship.io" \
          ActivePieces.scale=literal:1 \
          ActivePieces.icon=literal:"muximux-accusoft" \
          ActivePieces.color=literal:"#7c54e4" \
          ActivePieces.enabled=literal:"true" \
          ActivePieces.dd=literal:"true" \
          ZeroByte.name=literal:"ZeroByte" \
          ZeroByte.url=literal:"https://zerobyte.ghostship.io" \
          ZeroByte.scale=literal:1 \
          ZeroByte.icon=literal:"muximux-zeromq" \
          ZeroByte.color=literal:"#f35138" \
          ZeroByte.enabled=literal:"true" \
          ZeroByte.dd=literal:"true" \
          ...
          Syncthing.name=literal:"Syncthing" \
          Syncthing.url=literal:"https://syncthing.ghostship.io" \
          Syncthing.scale=literal:1 \
          Syncthing.icon=literal:"muximux-sync" \
          Syncthing.color=literal:"#107c10" \
          Syncthing.enabled=literal:"true" \
          Syncthing.dd=literal:"true" \
          ...
          Llama.name=literal:"Llama.cpp" \
          Llama.url=literal:"https://llama.ghostship.io" \
          Llama.scale=literal:1 \
          Llama.icon=literal:"muximux-chat" \
          Llama.color=literal:"#ffffff" \
          Llama.enabled=literal:"true" \
          Llama.dd=literal:"true" \
