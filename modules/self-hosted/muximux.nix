    ...
    text = ''
      ...
      if [ -f "$CONFIG_FILE" ]; then
        ...
        ${pkgs.ghostship-config}/bin/ghostship-config set "$CONFIG_FILE" \
          ...
          OpenWebUI.name=literal:"Open WebUI" \
          OpenWebUI.url=literal:"https://open-webui.ghostship.io" \
          OpenWebUI.scale=literal:1 \
          OpenWebUI.icon=literal:"muximux-chat" \
          OpenWebUI.color=literal:"#ffffff" \
          OpenWebUI.enabled=literal:"true" \
          ...
          Manyfold.name=literal:"Manyfold" \
          Manyfold.url=literal:"https://manyfold.ghostship.io" \
          Manyfold.scale=literal:1 \
          Manyfold.icon=literal:"muximux-medium" \
          Manyfold.color=literal:"#0d6efd" \
          Manyfold.enabled=literal:"true" \
          Manyfold.dd=literal:"true" \
          ...
          Huntarr.name=literal:"Huntarr" \
          Huntarr.url=literal:"https://huntarr.ghostship.io" \
          Huntarr.scale=literal:1 \
          Huntarr.icon=literal:"muximux-hexo" \
          Huntarr.color=literal:"#4a7be5" \
          Huntarr.enabled=literal:"true" \
          Huntarr.dd=literal:"true" \
