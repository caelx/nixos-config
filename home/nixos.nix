...

{
  ...
  programs.fish = {
    ...
    interactiveShellInit = ''
      ...
      # Source SSH agent environment provided by Home Manager's services.ssh-agent
      if test -f "$XDG_RUNTIME_DIR/ssh-agent-environment"
          source "$XDG_RUNTIME_DIR/ssh-agent-environment"
      end
    '';
    shellAliases = {
      # Core Aliases
