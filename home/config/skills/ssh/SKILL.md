...
- **Instruction to User**: "Please create a root tmux session on `<host>` using these commands: `tmux new-session -s agentroot 'sudo -i'`. You can then detach by pressing `Ctrl+b` then `d`."
